...
> **As a** user **I want to** choose between different subscription plans and pay for individual actions on demand **so that** I can use the platform according to my needs.
